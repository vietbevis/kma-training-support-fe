                ...
                <TableCell className='text-right w-20'>
                  <div className='flex justify-end gap-2'>
                    <PermissionButton
                      variant='outline'
                      size='icon'
                      onClick={() => onEdit(academicCredential)}
                      requiredPermission={PERMISSIONS.ACADEMIC_CREDENTIALS.UPDATE}
                    >
                    ...
                    <PermissionButton
                      variant='outline'
                      size='icon'
                      onClick={() => onDelete(academicCredential.id)}
                      requiredPermission={PERMISSIONS.ACADEMIC_CREDENTIALS.DELETE}
                    >
